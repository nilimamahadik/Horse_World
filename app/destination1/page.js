...
const page = () => {
  return (
    <ReveloLayout>
      <Banner pageTitle={"Horse"} search={true} />
              ...
              >
                ...
                <div className="content">
                  <h6>
                    ...
                    <Link href="destination-details">Kathiawadi</Link>
                  </h6>
                  {/* <span className="tours">258 tours</span> */}

                  <span className="tours">258 horses</span>
                </div>
              </div>
            </div>
            <div className="col">
              ...
              >
                ...
                <div className="content">
                  ...
                  {/* <span className="tours">258 tours</span> */}
                  <span className="tours">265 horses</span>
                </div>
              </div>
            </div>
            <div className="col">
              ...
              >
                ...
                <div className="content">
                  ...
                  {/* <span className="tours">258 tours</span> */}
                  <span className="tours">300 horses</span>
                </div>
              </div>
            </div>
            <div className="col">
              ...
              >
                ...
                <div className="content">
                  ...
                  <span className="tours">150 horses</span>
                </div>
              </div>
            </div>
            <div className="col">
