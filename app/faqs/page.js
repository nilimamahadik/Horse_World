            ...
            >
              <div className="feature-item style-three">
                ...
                <div className="content">
                  <h6>
                    <Link href="destination-details">10000+ Listings</Link>
                  </h6>
                  <p>
                  Your ultimate source for horse pedigree information. 
                  Our database provides detailed lineage records, performance history, and genetic insights to help breeders, owners, and enthusiasts make informed decisions.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="feature-item style-three bgc-secondary">
                ...
                <div className="content">
                  ...
                  Learn about legendary stallions and mares that have shaped the equestrian world.
                  </p>
                </div>
              </div>
            </div>
